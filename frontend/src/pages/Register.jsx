...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Automatically log them in for a seamless UX
      setTimeout(async () => {
        try {
  ...
  return (
    <div className="auth-page">
      <div className="card auth-card glass-panel p-4 p-sm-5">
        ...
        <p className="text-center text-muted mb-4">Create an account to start scheduling jobs.</p>
        ...
        {success && (
          <div className="alert alert-success rounded-3 py-2 px-3 small border-0" role="alert">
            {success}
          </div>
        )}
